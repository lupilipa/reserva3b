            ...
            <div class="item features-without-image mb-4 col-12 col-md-3 active">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="cad_func.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Cadastrar funcionários</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="exc_func.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Excluir funcionários</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
