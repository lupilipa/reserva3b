            ...
            <div class="item features-without-image mb-4 col-12 col-md-3 active">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="geren_func/geren_func.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Gerenciar funcionários</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="geren_esp_equip/geren_esp_equip.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Gerenciar espaços/equipamentos</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="geren_reserva/geren_reserva.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Gerenciar reservas</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
