        ...
        <div class="row justify-content-center"> 
            <div class="item features-without-image mb-4 col-12 col-md-3 active">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="cad_esp.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Cadastrar espaço</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mobi-mbri-website-theme-2 mobi-mbri" style="color: rgb(255, 225, 97); fill: rgb(255, 225, 97);"></span>
                        <a href="cad_equip.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Cadastrar equipamento</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        ...
                        <a href="exc_esp.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Excluir espaço</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
                <div class="item-wrapper">
                    <div class="card-box align-center">
                        <span class="mbr-iconfont mobi-mbri-credit-card mobi-mbri" style="color: rgb(255, 225, 97); fill: rgb(255, 225, 97);"></span>
                        <a href="exc_equip.php" class="card-title align-center mbr-black mbr-fonts-style display-7">
                            <h5><strong>Excluir equipamento</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-4 col-12 col-md-3">
