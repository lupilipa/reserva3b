    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Excluindo um espaço.</strong></h3>
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="" method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name">
                    <input type="hidden" name="email" data-form-email="true" value="gtrkQufxNT9qijC0yhrXuohox+W8KSfymgYTypwgdMqEaugU8U9TcOmOqjgQmcU8a5RCeMWjV6qBkMfE6MwDt7EUCsMbHdlRFdUqZbywWtlNlY+W48DTL9ZWt5iUg9Tl">
                    <p class="mbr-text mbr-fonts-style align-center mb-4 display-7">
                        Informe o código de cadastro do espaço (disponível no relatório 
                        de espaços/equipamentos) e a sua senha de admin.</p>
