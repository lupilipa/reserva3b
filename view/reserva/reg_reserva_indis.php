        ...
        <div class="row mb-5">
            <div class="col-12">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-2 display-2">
                    <strong>Oops! O horário que você escolheu já está preenchido</strong></h3> 
            </div>
        </div>
        <div class="row">
            <div class="item features-without-image mb-5 col-12 col-md-3 active">
                <div class="item-wrapper align-center">
                    <div class="iconfont-wrapper">
                        ...
                        <a href="reg_reserva.php" class="card-title mbr-fonts-style display-7">
                            <h5><strong>Tentar de novo</strong></h5></a>
                    </div>
                </div>
            </div>
            <div class="item features-without-image mb-5 col-12 col-md-3">
                <div class="item-wrapper align-center">
                    <div class="iconfont-wrapper">
                        ...
                        <a href="reg_reserva.php" class="card-title mbr-fonts-style display-7">
                            <h5><strong>Cancelar reserva</strong></h5></a>
                    </div>
                </div>
            </div>
        </div>
